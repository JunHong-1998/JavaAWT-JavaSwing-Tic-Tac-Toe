...
public class GameSetUp6 implements ActionListener,KeyListener,Runnable{		//LEE WENG HONG
	...
	JLabel SP_Background;JLabel MP_Background;JTextField NickP1;JTextField NickP2;
//////////////////////////////////////////////////////////////change P1 to P2 n vice versa
	private int WinCounter=1, match=0, move=9, Winner=0;
	int k,l;
	boolean symbol, turn=true, stop=false;
	...
	public void keyPressed(KeyEvent e) {
		if(e.getKeyCode() == KeyEvent.VK_ENTER){
				Ply1_name.setText(NickP2.getText());
				ply_turn1.setText(NickP2.getText());
				winner_turn1.setText(NickP2.getText());
				Ply2_name.setText(NickP1.getText());
				ply_turn2.setText(NickP1.getText());
				winner_turn2.setText(NickP1.getText());
				NickP1.setVisible(false);
				NickP2.setVisible(false);
				MP_Background.setVisible(false);
...
System.out.println("match : " +match);
			if(match ==0){
				...
				Defeat.setVisible(true);		//P1/host lose
	...
	public void GamePanel6(){
		GamePanel6.setLayout(null);
		NickP1 = new JTextField("Player 1");
		NickP1.setFont(f);
		NickP1.setBounds(150, 275, 200, 35);
		//NickP1.addKeyListener(this);
		NickP2 = new JTextField("Player 2");
		NickP2.setFont(f);
		NickP2.setBounds(150, 400, 200, 35);
		NickP2.addKeyListener(this);
		MP_Background = new JLabel(new ImageIcon("MP_Background.jpg"));
		MP_Background.setBounds(0, 0, 500, 800);
...
/////////////////////////////////// T u r n ///////////////////////////////
		...
		winner_turn1.setBounds(300,25,400,50);
...
/////////////////////////////////////////   N A M E & S C O R E   //////////////////////////////////////////////
		...
		GamePanel6.add(NickP1);
		GamePanel6.add(NickP2);
		GamePanel6.add(MP_Background);

		GamePanel6.add(Victory);
		GamePanel6.add(Defeat);
		GamePanel6.add(Draw);
		GamePanel6.add(BackgroundContinue);

		GamePanel6.add(winner_turn);
		GamePanel6.add(winner_turn1);
		GamePanel6.add(winner_turn2);
		GamePanel6.add(winner_draw);
		GamePanel6.add(ply_turn);
		GamePanel6.add(ply_turn1);
		GamePanel6.add(ply_turn2);
		...
		GamePanel6.add(WinX_symbol1);
		GamePanel6.add(WinO_symbol1);
		GamePanel6.add(WinX_symbol2);
		GamePanel6.add(WinO_symbol2);
		GamePanel6.add(WinX_symbol3);
		GamePanel6.add(WinO_symbol3);
		GamePanel6.add(WinX_symbol4);
		GamePanel6.add(WinO_symbol4);
		GamePanel6.add(WinX_symbol5);
		GamePanel6.add(WinO_symbol5);
		GamePanel6.add(WinX_symbol6);
		GamePanel6.add(WinO_symbol6);
		GamePanel6.add(WinX_symbol7);
		GamePanel6.add(WinO_symbol7);
		GamePanel6.add(WinX_symbol8);
		GamePanel6.add(WinO_symbol8);
		GamePanel6.add(WinX_symbol9);
		GamePanel6.add(WinO_symbol9);
		GamePanel6.add(X_symbol1);
		GamePanel6.add(O_symbol1);
		GamePanel6.add(X_symbol2);
		GamePanel6.add(O_symbol2);
		GamePanel6.add(X_symbol3);
		GamePanel6.add(O_symbol3);
		GamePanel6.add(X_symbol4);
		GamePanel6.add(O_symbol4);
		GamePanel6.add(X_symbol5);
		GamePanel6.add(O_symbol5);
		GamePanel6.add(X_symbol6);
		GamePanel6.add(O_symbol6);
		GamePanel6.add(X_symbol7);
		GamePanel6.add(O_symbol7);
		GamePanel6.add(X_symbol8);
		GamePanel6.add(O_symbol8);
		GamePanel6.add(X_symbol9);
		GamePanel6.add(O_symbol9);

		GamePanel6.add(Ply1_name);
		GamePanel6.add(Ply2_name);
		GamePanel6.add(Ply1_score1A);
		GamePanel6.add(Ply2_score1A);
		GamePanel6.add(Ply1_score2A);
		GamePanel6.add(Ply2_score2A);
		GamePanel6.add(Ply1_score3A);
		GamePanel6.add(Ply2_score3A);
		GamePanel6.add(Ply1_score1B);
		GamePanel6.add(Ply2_score1B);
		GamePanel6.add(Ply1_score2B);
		GamePanel6.add(Ply2_score2B);
		GamePanel6.add(Ply1_score3B);
		GamePanel6.add(Ply2_score3B);
		GamePanel6.add(Time1);
		GamePanel6.add(Time2);
		GamePanel6.add(Time3);

		GamePanel6.add(Continue);

		GamePanel6.add(Background5);

		GamePanel6.setSize(500,800);
...
System.out.println(Arrays.toString(ans));
		this.move=-1;
			...
			else if (this.match == 1 && this.move == 1){
			...
			else if (this.match == 2 && this.move == 1){
System.out.println("Running Draw Progress");
			...
			else if (this.match == 3 && this.move == 1){
