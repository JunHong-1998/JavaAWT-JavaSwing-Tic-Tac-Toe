...
public class GameSetUp5 implements ActionListener,KeyListener,Runnable{		//LOW JUN HONG
...
int k,l;
	...
	public void keyPressed(KeyEvent e) {
		if(e.getKeyCode() == KeyEvent.VK_ENTER){
				...
				Ply2_name.setText(NickP2.getText());
				ply_turn2.setText(NickP2.getText());
				winner_turn2.setText(NickP2.getText());
...
/////////////////////////////////// T u r n ///////////////////////////////
		...
		winner_turn2.setBounds(250,25,400,50);
...
/////////////////////////////////////////   N A M E & S C O R E   //////////////////////////////////////////////
		...
		GamePanel5.add(NickP1);
		GamePanel5.add(NickP2);
		GamePanel5.add(MP_Background);

		GamePanel5.add(Victory);
		GamePanel5.add(Defeat);
		GamePanel5.add(Draw);
		GamePanel5.add(BackgroundContinue);

		GamePanel5.add(winner_turn);
		GamePanel5.add(winner_turn1);
		GamePanel5.add(winner_turn2);
		GamePanel5.add(winner_draw);
		GamePanel5.add(ply_turn);
		GamePanel5.add(ply_turn1);
		GamePanel5.add(ply_turn2);
		...
		GamePanel5.add(WinX_symbol1);
		GamePanel5.add(WinO_symbol1);
		GamePanel5.add(WinX_symbol2);
		GamePanel5.add(WinO_symbol2);
		GamePanel5.add(WinX_symbol3);
		GamePanel5.add(WinO_symbol3);
		GamePanel5.add(WinX_symbol4);
		GamePanel5.add(WinO_symbol4);
		GamePanel5.add(WinX_symbol5);
		GamePanel5.add(WinO_symbol5);
		GamePanel5.add(WinX_symbol6);
		GamePanel5.add(WinO_symbol6);
		GamePanel5.add(WinX_symbol7);
		GamePanel5.add(WinO_symbol7);
		GamePanel5.add(WinX_symbol8);
		GamePanel5.add(WinO_symbol8);
		GamePanel5.add(WinX_symbol9);
		GamePanel5.add(WinO_symbol9);
		GamePanel5.add(X_symbol1);
		GamePanel5.add(O_symbol1);
		GamePanel5.add(X_symbol2);
		GamePanel5.add(O_symbol2);
		GamePanel5.add(X_symbol3);
		GamePanel5.add(O_symbol3);
		GamePanel5.add(X_symbol4);
		GamePanel5.add(O_symbol4);
		GamePanel5.add(X_symbol5);
		GamePanel5.add(O_symbol5);
		GamePanel5.add(X_symbol6);
		GamePanel5.add(O_symbol6);
		GamePanel5.add(X_symbol7);
		GamePanel5.add(O_symbol7);
		GamePanel5.add(X_symbol8);
		GamePanel5.add(O_symbol8);
		GamePanel5.add(X_symbol9);
		GamePanel5.add(O_symbol9);

		GamePanel5.add(Ply1_name);
		GamePanel5.add(Ply2_name);
		GamePanel5.add(Ply1_score1A);
		GamePanel5.add(Ply2_score1A);
		GamePanel5.add(Ply1_score2A);
		GamePanel5.add(Ply2_score2A);
		GamePanel5.add(Ply1_score3A);
		GamePanel5.add(Ply2_score3A);
		GamePanel5.add(Ply1_score1B);
		GamePanel5.add(Ply2_score1B);
		GamePanel5.add(Ply1_score2B);
		GamePanel5.add(Ply2_score2B);
		GamePanel5.add(Ply1_score3B);
		GamePanel5.add(Ply2_score3B);
		GamePanel5.add(Time1);
		GamePanel5.add(Time2);
		GamePanel5.add(Time3);

		GamePanel5.add(Continue);

		GamePanel5.add(Background5);

		GamePanel5.setSize(500,800);
...
System.out.println("WinCounter : " +WinCounter);
	...
	public void Progress(){
		...
		WIN_condition(ans);
		this.move--;
	System.out.println("Current move : " +this.move);
	}
