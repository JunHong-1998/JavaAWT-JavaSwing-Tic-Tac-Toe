...
public class GameSetUp2 implements ActionListener,KeyListener,Runnable{		//LEONG YAU WAH & LOW JUN HONG
...
/////////////////////////////////////////   N A M E & S C O R E   //////////////////////////////////////////////
		...
		GamePanel2.add(SP_Background);
		GamePanel2.add(NickP1);
		GamePanel2.add(Victory);
		GamePanel2.add(Defeat);
		GamePanel2.add(Draw);
		GamePanel2.add(BackgroundContinue);

		GamePanel2.add(winner_turn);
		GamePanel2.add(winner_turn1);
		GamePanel2.add(winner_turn2);
		GamePanel2.add(winner_draw);
		GamePanel2.add(ply_turn);
		GamePanel2.add(ply_turn1);
		GamePanel2.add(ply_turn2);
		...
		GamePanel2.add(WinX_symbol1);
		GamePanel2.add(WinO_symbol1);
		GamePanel2.add(WinX_symbol2);
		GamePanel2.add(WinO_symbol2);
		GamePanel2.add(WinX_symbol3);
		GamePanel2.add(WinO_symbol3);
		GamePanel2.add(WinX_symbol4);
		GamePanel2.add(WinO_symbol4);
		GamePanel2.add(WinX_symbol5);
		GamePanel2.add(WinO_symbol5);
		GamePanel2.add(WinX_symbol6);
		GamePanel2.add(WinO_symbol6);
		GamePanel2.add(WinX_symbol7);
		GamePanel2.add(WinO_symbol7);
		GamePanel2.add(WinX_symbol8);
		GamePanel2.add(WinO_symbol8);
		GamePanel2.add(WinX_symbol9);
		GamePanel2.add(WinO_symbol9);
		GamePanel2.add(X_symbol1);
		GamePanel2.add(O_symbol1);
		GamePanel2.add(X_symbol2);
		GamePanel2.add(O_symbol2);
		GamePanel2.add(X_symbol3);
		GamePanel2.add(O_symbol3);
		GamePanel2.add(X_symbol4);
		GamePanel2.add(O_symbol4);
		GamePanel2.add(X_symbol5);
		GamePanel2.add(O_symbol5);
		GamePanel2.add(X_symbol6);
		GamePanel2.add(O_symbol6);
		GamePanel2.add(X_symbol7);
		GamePanel2.add(O_symbol7);
		GamePanel2.add(X_symbol8);
		GamePanel2.add(O_symbol8);
		GamePanel2.add(X_symbol9);
		GamePanel2.add(O_symbol9);

		GamePanel2.add(Ply1_name);
		GamePanel2.add(Ply2_name);
		GamePanel2.add(Ply1_score1A);
		GamePanel2.add(Ply2_score1A);
		GamePanel2.add(Ply1_score2A);
		GamePanel2.add(Ply2_score2A);
		GamePanel2.add(Ply1_score3A);
		GamePanel2.add(Ply2_score3A);
		GamePanel2.add(Ply1_score1B);
		GamePanel2.add(Ply2_score1B);
		GamePanel2.add(Ply1_score2B);
		GamePanel2.add(Ply2_score2B);
		GamePanel2.add(Ply1_score3B);
		GamePanel2.add(Ply2_score3B);
		GamePanel2.add(Time1);
		GamePanel2.add(Time2);
		GamePanel2.add(Time3);

		GamePanel2.add(Continue);

		GamePanel2.add(Background5);

		GamePanel2.setSize(500,800);
