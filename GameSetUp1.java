...
public class GameSetUp1 implements ActionListener,KeyListener,Runnable{		//LEONG YAU WAH
...
/////////////////////////////////////////   N A M E & S C O R E   //////////////////////////////////////////////
		...
		GamePanel1.add(SP_Background);
		GamePanel1.add(NickP1);
		GamePanel1.add(Victory);
		GamePanel1.add(Defeat);
		GamePanel1.add(Draw);
		GamePanel1.add(BackgroundContinue);

		GamePanel1.add(winner_turn);
		GamePanel1.add(winner_turn1);
		GamePanel1.add(winner_turn2);
		GamePanel1.add(winner_draw);
		GamePanel1.add(ply_turn);
		GamePanel1.add(ply_turn1);
		GamePanel1.add(ply_turn2);
		...
		GamePanel1.add(WinX_symbol1);
		GamePanel1.add(WinO_symbol1);
		GamePanel1.add(WinX_symbol2);
		GamePanel1.add(WinO_symbol2);
		GamePanel1.add(WinX_symbol3);
		GamePanel1.add(WinO_symbol3);
		GamePanel1.add(WinX_symbol4);
		GamePanel1.add(WinO_symbol4);
		GamePanel1.add(WinX_symbol5);
		GamePanel1.add(WinO_symbol5);
		GamePanel1.add(WinX_symbol6);
		GamePanel1.add(WinO_symbol6);
		GamePanel1.add(WinX_symbol7);
		GamePanel1.add(WinO_symbol7);
		GamePanel1.add(WinX_symbol8);
		GamePanel1.add(WinO_symbol8);
		GamePanel1.add(WinX_symbol9);
		GamePanel1.add(WinO_symbol9);
		GamePanel1.add(X_symbol1);
		GamePanel1.add(O_symbol1);
		GamePanel1.add(X_symbol2);
		GamePanel1.add(O_symbol2);
		GamePanel1.add(X_symbol3);
		GamePanel1.add(O_symbol3);
		GamePanel1.add(X_symbol4);
		GamePanel1.add(O_symbol4);
		GamePanel1.add(X_symbol5);
		GamePanel1.add(O_symbol5);
		GamePanel1.add(X_symbol6);
		GamePanel1.add(O_symbol6);
		GamePanel1.add(X_symbol7);
		GamePanel1.add(O_symbol7);
		GamePanel1.add(X_symbol8);
		GamePanel1.add(O_symbol8);
		GamePanel1.add(X_symbol9);
		GamePanel1.add(O_symbol9);

		GamePanel1.add(Ply1_name);
		GamePanel1.add(Ply2_name);
		GamePanel1.add(Ply1_score1A);
		GamePanel1.add(Ply2_score1A);
		GamePanel1.add(Ply1_score2A);
		GamePanel1.add(Ply2_score2A);
		GamePanel1.add(Ply1_score3A);
		GamePanel1.add(Ply2_score3A);
		GamePanel1.add(Ply1_score1B);
		GamePanel1.add(Ply2_score1B);
		GamePanel1.add(Ply1_score2B);
		GamePanel1.add(Ply2_score2B);
		GamePanel1.add(Ply1_score3B);
		GamePanel1.add(Ply2_score3B);
		GamePanel1.add(Time1);
		GamePanel1.add(Time2);
		GamePanel1.add(Time3);

		GamePanel1.add(Continue);

		GamePanel1.add(Background5);

		GamePanel1.setSize(500,800);
...
System.out.println("Player's move :" +ans);
	...
	public void PC_move_byMatch(){
		if( match==1 && move>=1 || match ==3 && move>=1 ){
			PC_move1();
		}
		else
		if(match == 2 && move>=2){
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	System.out.println("AIM 1");
			...
			|| PC_ans[0]==5 && PC_ans[1]==5 || PC_ans[0]==5 && PC_ans[1]==5
			|| PC_ans[0]==5 && PC_ans[2]==5 || PC_ans[0]==5 && PC_ans[2]==5
			|| PC_ans[0]==5 && PC_ans[3]==5 || PC_ans[0]==5 && PC_ans[3]==5
			|| PC_ans[1]==5 && PC_ans[2]==5 || PC_ans[1]==5 && PC_ans[2]==5
			|| PC_ans[1]==5 && PC_ans[3]==5 || PC_ans[1]==5 && PC_ans[3]==5
			|| PC_ans[2]==5 && PC_ans[3]==5 || PC_ans[2]==5 && PC_ans[3]==5){
	System.out.println("AIM 2");
				ans=2;
			}
			}
	...
	System.out.println("AIM 5");
			...
			if (error[6]!=6){
			if(PC_ans[0]==9 && PC_ans[1]==4 || PC_ans[0]==4 && PC_ans[1]==9
			|| PC_ans[0]==9 && PC_ans[2]==4 || PC_ans[0]==4 && PC_ans[2]==9
			|| PC_ans[0]==9 && PC_ans[3]==4 || PC_ans[0]==4 && PC_ans[3]==9
			|| PC_ans[1]==9 && PC_ans[2]==4 || PC_ans[1]==4 && PC_ans[2]==9
			|| PC_ans[1]==9 && PC_ans[3]==4 || PC_ans[1]==4 && PC_ans[3]==9
			|| PC_ans[2]==9 && PC_ans[3]==4 || PC_ans[2]==4 && PC_ans[3]==9
